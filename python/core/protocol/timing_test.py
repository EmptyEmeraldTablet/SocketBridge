...
if __name__ == "__main__":
    tm = TimingMonitor()
    print("TimingMonitor created successfully")
    ...
    print(f"MessageTimingInfo created: seq={timing.seq}, frame={timing.frame}")

    issues = tm.check_message(timing)
